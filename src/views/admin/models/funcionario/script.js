...
Array.isArray(funcionarios)
  ? funcionarios.forEach((funcionario) => {
      ...
      fields.forEach((field) => {
        ...
        td.innerHTML = funcionario[field]
        tr.appendChild(td)
      })
...
cadastrar.addEventListener("click", () => {
  ...
  button.addEventListener("click", async (e) => {
    ...
    try {
      const response = await fetch(
        "https://breno-papelaria.onrender.com/funcionarios",
        {
          method: "POST",
          headers: {
...
const trClicked = (event) => {
  ...
  buttonTrash.addEventListener("click", async () => {
    const response = await fetch(
      "https://breno-papelaria.onrender.com/funcionarios/" + id,
      {
        method: "DELETE",
      }
    )
