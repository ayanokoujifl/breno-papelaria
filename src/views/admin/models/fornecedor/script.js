...
const fornecedores = await getProdutos()
...
const fields = ["id_forn", "nome", "telefone", "cnpj"]
...
cadastrar.addEventListener("click", () => {
  ...
  button.addEventListener("click", async (e) => {
    ...
    try {
      const response = await fetch(
        "https://breno-papelaria.onrender.com/fornecedores",
        {
          method: "POST",
          headers: {
...
const trClicked = (event) => {
  ...
  buttonTrash.addEventListener("click", async () => {
    const response = await fetch(
      "https://breno-papelaria.onrender.com/fornecedores/" + id,
      {
        method: "DELETE",
      }
    )
